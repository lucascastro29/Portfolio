...
export default class Collapser extends Component {
  constructor(props) {
    ...
    this.state = {
      aosFR: "fade-right",
      aos1: "d-flex triggersbox2",
      aos2: "d-flex triggersbox3",
    };
    this.windowsWith = this.windowsWith.bind(this);
      ...
      <>
        ...
        <div className="col-sm-5 col-12" style={{ padding: "0px" }}>
          ...
          <p
            ...
            data-aos-delay="300"
          >
            I worked in "Cyber Green" Since 2020 until 2022 working us a
            computer technical service and client service.
          </p>
        </div>
          ...
          >
            <ul>
              <li style={{ margin: "20px" }}>
                Bachiller cientific in Liceo 15 since March 2018 until December
                2020
              </li>
              <li style={{ margin: "20px" }}>
                First year of Computer engenier in the "Facultad de Ingeniería
                de la Republica"
              </li>
              <li style={{ margin: "20px" }}>
